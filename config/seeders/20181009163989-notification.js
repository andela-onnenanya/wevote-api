  ...
  up(queryInterface) {
    return queryInterface.bulkInsert('Notifications', [
      ...
      },
      {
        code: 'C2',
        group: '3',
        message: 'Your temporary voters card will not give Nigeria the permanent change ' +
        'she needs; go for your Permanent Voters Card!',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
      ...
      },
      {
        code: 'G1',
        group: '7',
        message: "Since you didn't register within your city, it would be very difficult for " +
        'you to vote because there will be restriction of movement on the election days. ' +
        'However, you can transfer your registration to a center near you. Visit a registration ' +
        'center or an INEC office.',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
